        ...
        public class DrawBluePrint : MonoBehaviour
        {
                            ...
                            if (nowPoint.y > priviousPoint.y)
                            {
                                ...
                                else
                                {
                                    for (float n = 0; n < (int)(nowPoint.y - priviousPoint.y); n+=0.5f)
                                    {
                                        if ((int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)) > 0 && (int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)) < 256 && (int)(priviousPoint.y + n) > 0 && (int)(priviousPoint.y + n) < 256)
                                        {
                                            drawTexture.SetPixel((int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)), (int)(priviousPoint.y + n), DrawColor2);
                                        }

                                        if ((int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)) > 0 + 1 && (int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)) + 1 < 256 && (int)(priviousPoint.y + n) > 0 && (int)(priviousPoint.y + n) < 256)
                                        {
                                            drawTexture.SetPixel((int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)) + 1, (int)(priviousPoint.y + n), DrawColor2);
                                        }
                                        ...
                                        if ((int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)) > 0 && (int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)) < 256 && (int)(priviousPoint.y + n) + 1 > 0 && (int)(priviousPoint.y + n) + 1 < 256)
                                        {
                                            drawTexture.SetPixel((int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (nowPoint.y - priviousPoint.y) * n)), (int)(priviousPoint.y + n) + 1, DrawColor2);
                                        }
            ...
            private void Erase()
            {
                if (Getprivious == true)
                {
                    if (Getprivious == true)
                    {
                        if ((nowPoint.x - priviousPoint.x) * (nowPoint.x - priviousPoint.x) > (nowPoint.y - priviousPoint.y) * (nowPoint.y - priviousPoint.y))
                        {
                            if (nowPoint.x > priviousPoint.x)
                            {
                                if (nowPoint.y > priviousPoint.y)
                                {
                                    for (int n = 0; n <= (int)(nowPoint.x - priviousPoint.x); n++)
                                    {
                                        drawTexture.SetPixel((int)(priviousPoint.x + n), (int)(priviousPoint.y + (nowPoint.y - priviousPoint.y) / (int)(nowPoint.x - priviousPoint.x) * n), EraseColor);
                                    }
                                ...
                                else
                                {
                                    if (PhotonScriptor.ConnectingScript.informPlayerID() == 1)
                                    {
                                        for (int n = 0; n <= (int)(nowPoint.x - priviousPoint.x); n++)
                                        {
                                            drawTexture.SetPixel((int)(priviousPoint.x + n), (int)(nowPoint.y + (priviousPoint.y - nowPoint.y) / n), DrawColor1);
                                        }
                                    }
                            ...
                            else
                            {
                                if (nowPoint.y > priviousPoint.y)
                                {
                                    for (int n = 0; n <= (int)(priviousPoint.x - nowPoint.x); n++)
                                    {
                                        drawTexture.SetPixel((int)(nowPoint.x + n), (int)(priviousPoint.y + (nowPoint.y - priviousPoint.y) / (int)(priviousPoint.x - nowPoint.x) * n), EraseColor);
                                    }
                                ...
                                else
                                {
                                    for (int n = 0; n <= (int)(priviousPoint.x - nowPoint.x); n++)
                                    {
                                        drawTexture.SetPixel((int)(nowPoint.x + n), (int)(nowPoint.y + (priviousPoint.y - nowPoint.y) / (int)(priviousPoint.x - nowPoint.x) * n), EraseColor);
                                    }
                        ...
                        else
                        {
                            if (nowPoint.x > priviousPoint.x)
                            {
                                if (nowPoint.y > priviousPoint.y)
                                {
                                    for (int n = 0; n <= (int)(nowPoint.y - priviousPoint.y); n++)
                                    {
                                        drawTexture.SetPixel((int)(priviousPoint.x + (nowPoint.x - priviousPoint.x)) * n / (int)(nowPoint.y - priviousPoint.y), (int)(priviousPoint.y + n), EraseColor);
                                    }
                                }
                                else
                                {
                                    for (int n = 0; n <= (int)(nowPoint.x - priviousPoint.x); n++)
                                    {
                                        drawTexture.SetPixel((int)(priviousPoint.x + (nowPoint.x - priviousPoint.x)) * n / (int)(priviousPoint.y - nowPoint.y), (int)(nowPoint.y + n),EraseColor);
                                    }
                            ...
                            else
                            {
                                if (nowPoint.y > priviousPoint.y)
                                {
                                    for (int n = 0; n <= (int)(nowPoint.y - priviousPoint.y); n++)
                                    {
                                        drawTexture.SetPixel((int)(nowPoint.x + (priviousPoint.x - nowPoint.x) / (int)(nowPoint.y - priviousPoint.y)) * n, (int)(priviousPoint.y + n), EraseColor);
                                    }
                                }
                                else
                                {
                                    for (int n = 0; n <= (int)(priviousPoint.y - nowPoint.y); n++)
                                    {
                                        drawTexture.SetPixel((int)(nowPoint.x + ((priviousPoint.x - nowPoint.x) / (int)(priviousPoint.y - nowPoint.y) * n)), (int)(nowPoint.y + n), EraseColor);
                                    }
                                }
                            }
                        }
